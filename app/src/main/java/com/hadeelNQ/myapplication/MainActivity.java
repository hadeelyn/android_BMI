        ...
        private void loginListener() {
            login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(usernamel.equals("admin")&& password.equals("123")){
                    ...
                    fAuth.signInWithUsernameAndPassword(usernamel, userpassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
