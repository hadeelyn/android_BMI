...
public final class ActivityNewRecordBinding implements ViewBinding {
  ...
  private ActivityNewRecordBinding(@NonNull RelativeLayout rootView, @NonNull Button button,
      ...
      @NonNull EditText editTextTextPersonName3, @NonNull EditText edittime,
      @NonNull LinearLayout laoyoutBack, @NonNull LinearLayout layoutDate,
  ...
  public static ActivityNewRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewRecordBinding((RelativeLayout) rootView, button, button2, button3,
          button4, editTextTextPersonName, editTextTextPersonName2, editTextTextPersonName3,
          edittime, laoyoutBack, layoutDate, layoutLength, layoutLogo, layoutWeight, textView,
          textView3);
    }
