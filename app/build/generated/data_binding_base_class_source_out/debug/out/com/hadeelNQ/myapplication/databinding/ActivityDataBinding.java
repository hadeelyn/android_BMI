...
public final class ActivityDataBinding implements ViewBinding {
  ...
  private ActivityDataBinding(@NonNull RelativeLayout rootView, @NonNull Button button,
      ...
      @NonNull EditText date, @NonNull LinearLayout laoyoutBack, @NonNull LinearLayout layoutLength,
      @NonNull LinearLayout layoutLogo, @NonNull LinearLayout layoutReg,
      @NonNull LinearLayout layoutWeight, @NonNull EditText lenght, @NonNull TextView textView,
      @NonNull TextView textView3, @NonNull EditText weight) {
  ...
  public static ActivityDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lenght;
      EditText lenght = ViewBindings.findChildViewById(rootView, id);
      if (lenght == null) {
        break missingId;
      }
      ...
      return new ActivityDataBinding((RelativeLayout) rootView, button, button2, button3, button4,
          date, laoyoutBack, layoutLength, layoutLogo, layoutReg, layoutWeight, lenght, textView,
          textView3, weight);
    }
